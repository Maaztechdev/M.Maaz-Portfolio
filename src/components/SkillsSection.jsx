...
const skills = [
  ...
  // Desktop
  { name: "Electron JS", level: 80, category: "desktop" },
  // Backend
  { name: "PHP", level: 90, category: "backend" },
  { name: "Laravel", level: 85, category: "backend" },
  { name: "DataBase", level: 90, category: "backend" },
  { name: "Next js", level: 90, category: "backend" },
  { name: "Node js", level: 90, category: "backend" },
  { name: "MangoDB", level: 90, category: "backend" },
...
const categories = ["all", "frontend","mobile", "desktop", "backend", "tools"];
